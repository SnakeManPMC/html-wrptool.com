...
<p><a href="images/wrptool-big.jpg"><img src="images/wrptool-small.jpg" width="128" height="128" alt="WrpTool"></a>WrpTool
</p>
...
<p>Download ODOL Explorer v2.0 (MLOD converter) <a href="downloads/ODOL_Explorer_v2.0.rar">ODOL_Explorer_v2.0.rar</a>
</p>

<p>Notice that first time users need to download both of the above rars, old v0.906 users can download only the upgrade and unrar it to their existing dir to get the v0.95 running. Please, please we plead to you to read the manual...
</p>
...
</b>ODOL Explorer v2.0 has been released as standalone download. This is the util to view p3d models and to save the ODOL format into MLOD format which can be read and edited with O2. Here is a screenshot of <a href="images/OdEx1.jpg">ODOL Explorer</a> in action. Download ODOL Explorer v2.0 <a href="downloads/ODOL_Explorer_v2.0.rar">here</a>. We will miss Rom since he decided to quit WrpTool development team because he as BAS member cannot stand MLOD converter to be released for the OFP community.
</p>
